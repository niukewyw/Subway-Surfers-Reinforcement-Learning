...
**The project code is generated by DeepSeek. The training performance is currently unknown and still under testing. However, one thing is clear: since the source data of the game cannot be obtained but is instead trained and collected offline through screen recognition, the online training and offline data collection will be very slow. Moreover, during the process of online training and offline data collection, it will occupy your computer mouse, preventing your computer from performing other tasks. Therefore, this project is only for entertainment purposes. If I manage to train a more effective model and collect a complete offline data set in the future, I will upload them promptly.**
